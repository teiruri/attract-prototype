...
import { ArrowLeft, Sparkles, Loader2, Copy, CheckCircle2, FileText } from 'lucide-react'
          ...
          <div className="card overflow-hidden">
            <div className="bg-gray-50 border-b border-gray-200 px-6 py-3">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-medium text-gray-700">ブリーフィング資料</span>
                  {generating && (
            ...
            {!generating && result && (
              <div className="px-6 py-3 border-t border-gray-100 bg-gray-50 flex justify-between items-center">
                <p className="text-xs text-gray-400">このブリーフィングはAIが候補者情報をもとに自動生成しました。内容を確認してご活用ください。</p>
