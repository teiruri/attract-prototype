#!/usr/bin/env python3
"""
Generate SRT subtitle files for カケハシOS tutorial video.
...
# 13 scenes matching generate-narration.py
SCENES = [
    {
        "id": "00_opening",
        "duration_s": 16.0,
        "narration": "せっかく優秀な人材に出会えたのに、辞退されてしまった。そんな経験はありませんか？カケハシオーエスは、候補者ひとりひとりに合った最適なひきつけ方を、AIが自動で設計する仕組みです。操作画面で、その流れをご紹介します。",
    },
    {
        "id": "01_login",
        "duration_s": 4.5,
    ...
    },
    {
        "id": "03_revp_report",
        "duration_s": 38.0,
        "narration": "ここで、カケハシオーエスの土台となる機能をご紹介します。レップ診断レポートです。レップとは、求職者から見た自社の採用力を診断する仕組みです。内定者や社員のサーベイ結果をもとに、自社の魅力を7つの項目で数値化。職種ごとに、どんなターゲットに対して、どんな魅力をアピールすべきかを、データの裏付けも加味して設定します。人事と現場の認識のズレや、入社前と入社後のギャップも、見える化されます。この診断内容を土台として、候補者ひとりひとりの志向や興味に合わせてひきつけ戦略が設計されていきます。",
    },
    {
    ...
    },
    {
        "id": "05_scout_mail",
        "duration_s": 25.0,
        "narration": "カケハシオーエスでは、スカウトメールの文面もAIが自動で作成できます。レップ診断で明確になった自社の魅力と、候補者のプロフィールをかけあわせて、響くスカウトメールを生成します。候補者がスカウトメールに反応して応募してくれた場合、その反応履歴は、カルテや選考設計に自動で反映されます。スカウトメールの配信は、トレイの配信代行サービスと連携しています。",
    },
    {
        "id": "06_document_upload",
        "duration_s": 16.0,
        "narration": "書類管理では、アップロードした履歴書をAIが自動で解析します。技術、資格、経歴を、整理されたデータとして取り出します。さらに、この候補者をひきつけるためのヒントまで、自動で提案してくれます。",
    },
    {
        "id": "07_signal_extraction",
        "duration_s": 16.0,
    ...
    },
    {
        "id": "12_ending",
        "duration_s": 18.0,
        "narration": "カケハシオーエスは、経験と勘にたよった採用活動から脱却し、候補者ひとりひとりの心の動きをデータとして可視化し、チームで共有する仕組みです。候補者をひきつけて選ばれる採用プロセスを、カケハシオーエスで実現しましょう。ご視聴ありがとうございました。",
    },
]
