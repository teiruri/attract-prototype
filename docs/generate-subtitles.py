#!/usr/bin/env python3
"""
Generate SRT subtitle files for ATTRACT tutorial video.
...
# 12 scenes matching generate-narration.py
SCENES = [
    {
        "id": "00_opening",
        "duration_s": 16.0,
        "narration": "せっかく優秀な人材に出会えたのに、辞退されてしまった。そんな経験はありませんか？アトラクトは、候補者ひとりひとりに合った最適なひきつけ方を、AIが自動で設計する仕組みです。操作画面で、その流れをご紹介します。",
    },
    {
        "id": "01_login",
        "duration_s": 4.5,
    ...
    },
    {
        "id": "03_revp_report",
        "duration_s": 38.0,
        "narration": "ここで、アトラクトの土台となる機能をご紹介します。レップ診断レポートです。レップとは、求職者から見た自社の採用力を診断する仕組みです。内定者や社員のサーベイ結果をもとに、自社の魅力を7つの項目で数値化。職種ごとに、どんなターゲットに対して、どんな魅力をアピールすべきかを、データの裏付けも加味して設定します。人事と現場の認識のズレや、入社前と入社後のギャップも、見える化されます。この診断内容を土台として、候補者ひとりひとりの志向や興味に合わせてひきつけ戦略が設計されていきます。",
    },
    {
    ...
    },
    {
        "id": "11_ending",
        "duration_s": 18.0,
        "narration": "アトラクトは、経験と勘にたよった採用活動から脱却し、候補者ひとりひとりの心の動きをデータとして可視化し、チームで共有する仕組みです。候補者をひきつけて選ばれる採用プロセスを、アトラクトで実現しましょう。ご視聴ありがとうございました。",
    },
]
