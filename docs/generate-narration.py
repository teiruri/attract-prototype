"""
HR FARM チュートリアル動画 ナレーション音声生成スクリプト
...
SCENES = [
    {
        ...
        "text": (
            ...
            "そんな経験はありませんか？"
            "エイチアールファームは、応募者の志望度を耕し、採用確率を高める仕組みです。"
            "候補者ひとりひとりに合った最適なひきつけ方を、AIが自動で設計します。"
            "操作画面で、その流れをご紹介します。"
        ),
    },
    {
    ...
    },
    {
        ...
        "text": (
            "エイチアールファームは、経験と勘にたよった採用活動から脱却し、"
...
async def main():
    print("=" * 60)
    print("HR FARM チュートリアル ナレーション音声生成")
