"""
カケハシOS チュートリアル動画 ナレーション音声生成スクリプト
...
# 04_register → 05_scout_mail → 06_document → 07_signal →
# 08_ai_interview → 09_attract → 10_feedback → 11_brief → 12_ending
#
...
SCENES = [
    {
        ...
        "text": (
            ...
            "そんな経験はありませんか？"
            "カケハシオーエスは、候補者ひとりひとりに合った最適なひきつけ方を、"
            "AIが自動で設計する仕組みです。"
            "操作画面で、その流れをご紹介します。"
        ),
    },
    ...
    {
        "filename": "05_scout_mail.mp3",
        "text": (
            "カケハシオーエスでは、スカウトメールの文面もAIが自動で作成できます。"
            "レップ診断で明確になった自社の魅力と、"
            "候補者のプロフィールをかけあわせて、"
            "響くスカウトメールを生成します。"
            "候補者がスカウトメールに反応して応募してくれた場合、"
            "その反応履歴は、カルテや選考設計に自動で反映されます。"
            "スカウトメールの配信は、トレイの配信代行サービスと連携しています。"
        ),
    },
    {
        "filename": "06_document_upload.mp3",
        "text": (
    ...
    {
        "filename": "07_signal_extraction.mp3",
        "text": (
    ...
    {
        "filename": "09_attract_strategy.mp3",
        "text": (
            "ひきつけ戦略ボードです。"
    ...
    {
        "filename": "12_ending.mp3",
        "text": (
            "カケハシオーエスは、経験と勘にたよった採用活動から脱却し、"
...
async def main():
    print("=" * 60)
    print("カケハシOS チュートリアル ナレーション音声生成")
